...
from clinic_utilities import login, register#, login_display_status, register_display_status
from UI.Clinic_Login_UI import Login_Form; from UI.Clinic_Register_UI import Register_Form
#import webbrowser

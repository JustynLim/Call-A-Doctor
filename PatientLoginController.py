...
from patient_utilities import login, register
from UI.Patient_Login_UI import Login_Form; from UI.Patient_Register_UI import Register_Form
...
class LoginController(QtWidgets.QMainWindow):
    ...
    def show_register_form(self):
        ...
        self.register_form.lineEdit_3.setFocus()  # Set focus directly
    ...
    def display_register_status(self, status):
        ...
        if status == 0:
            self.register_form.label_18.setText("Name cannot be blank")
        ...
        if status == 1:
            ...
            self.register_form.label_18.setText("Email already exist")
            self.register_form.label_18.setStyleSheet("color:red")
            ...
            self.register_form.label_18.setText("Address cannot be blank")
            self.register_form.label_18.setStyleSheet("color:red")

...
class MySideBar(QMainWindow, Ui_MainWindow):
    ...
    def add_doctor(self):
        ...
        cursor.execute("INSERT INTO DOCTORS (DOCTOR_EMAIL, DOCTOR_NAME, DOCTOR_PHONENO, DOCTOR_ADDRESS, CLINIC_NAME, ACTIVATION_CODE) VALUES (?, ?, ?, ?, ?, ?)", (doctor_email, doctor_name, doctor_phone, doctor_address, self.clinic_name, activation_code))
        connection.commit()

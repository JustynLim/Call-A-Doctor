...
"color: rgb(255, 255, 255);")
        ...
        # Set the text color to white using a single "color" property
        self.table_todaySchedule.setStyleSheet(u"color: white;")
        #self.table_todaySchedule.setStyleSheet(u"border: 1px solid rgb(255, 255, 255), color: white;")

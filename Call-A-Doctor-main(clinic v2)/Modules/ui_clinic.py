...
from PySide6.QtWidgets import (QGridLayout, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QSpacerItem, QSizePolicy, QStackedWidget, QWidget, QMainWindow, QTableWidget, QTableWidgetItem, QLineEdit, QMessageBox, QDialog, QVBoxLayout, QComboBox)
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QIcon()
        icon3.addFile(u":/images/cil-schedule.png", QSize(), QIcon.Normal, QIcon.Off)
        self.addschedule_1.setIcon(icon3)
        ...
        self.addschedule_2.setIcon(icon3)
        ...
        self.logout_2 = QPushButton(self.widget_2)
        self.logout_2.setObjectName(u"logout_2")
        self.logout_2.setIcon(icon4)
        ...
        self.shortcut_add.setGeometry(QRect(20, 80, 181, 361))
        self.shortcut_add.setMinimumSize(QSize(181, 361))
        self.shortcut_add.setMaximumSize(QSize(181, 361))
        ...
        self.shortcut_view.setGeometry(QRect(230, 80, 181, 361))
        self.shortcut_view.setMinimumSize(QSize(181, 361))
        self.shortcut_view.setMaximumSize(QSize(181, 361))
        ...
        self.shortcut_schedule.setGeometry(QRect(430, 80, 181, 361))
        self.shortcut_schedule.setMinimumSize(QSize(181, 361))
        self.shortcut_schedule.setMaximumSize(QSize(181, 361))
        ...
        "border:none;")
        icon6 = QIcon()
        icon6.addFile(u":/images/check-mark.png", QSize(), QIcon.Normal, QIcon.Off)
        self.confirm_button.setIcon(icon6)
        ...
        "border-radius:10px;")
        icon7 = QIcon()
        icon7.addFile(u":/images/bin.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.schedule_table.setHorizontalHeaderItem(0, __qtablewidgetitem4)
        __qtablewidgetitem5 = QTableWidgetItem()
        self.schedule_table.setHorizontalHeaderItem(1, __qtablewidgetitem5)
        __qtablewidgetitem6 = QTableWidgetItem()
        self.schedule_table.setHorizontalHeaderItem(2, __qtablewidgetitem6)
        ...
        "border-radius:10px;")
        icon8 = QIcon()
        icon8.addFile(u":/images/calendar.png", QSize(), QIcon.Normal, QIcon.Off)
        self.addschedule_button.setIcon(icon8)
        ...
        "border-radius:10px;")
        icon9 = QIcon()
        icon9.addFile(u":/images/check (1).png", QSize(), QIcon.Normal, QIcon.Off)
        self.selectdoctor_button.setIcon(icon9)
        ...
        self.doctor_name_label.setGeometry(QRect(310, 50, 61, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.addschedule_2.setText(QCoreApplication.translate("MainWindow", u"Add Schedule", None))
        self.logout_2.setText(QCoreApplication.translate("MainWindow", u"Log Out", None))
        self.menu.setText("")
        ...
        ___qtablewidgetitem4 = self.schedule_table.horizontalHeaderItem(0)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"Task", None))
        ___qtablewidgetitem5 = self.schedule_table.horizontalHeaderItem(1)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MainWindow", u"Date", None))
        ___qtablewidgetitem6 = self.schedule_table.horizontalHeaderItem(2)
        ...
        self.doctor_name_label.setText(QCoreApplication.translate("MainWindow", u"Doctor ___", None))
    # retranslateUi
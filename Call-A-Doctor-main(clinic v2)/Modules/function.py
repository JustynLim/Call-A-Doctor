from PySide6.QtWidgets import QMainWindow, QTableWidgetItem, QMessageBox, QVBoxLayout, QComboBox, QDialog, QPushButton, QLabel, QApplication
from Modules.ui_clinic import Ui_MainWindow
import sqlite3
import os
import random
import string
...
class MySideBar(QMainWindow, Ui_MainWindow):
    def __init__(self, doctor_email=None):
        super().__init__()
        self.setupUi(self)

...
from patient_utilities import register
...
class Register_Form(QtWidgets.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.toggle_button_2.setGeometry(QtCore.QRect(int(600 * scaling_factor), int(225 * scaling_factor), int(30 * scaling_factor), int(30 * scaling_factor)))
        ...
        self.toggle_button_3.setGeometry(QtCore.QRect(int(600 * scaling_factor), int(265 * scaling_factor), int(30 * scaling_factor), int(30 * scaling_factor)))
        ...
        self.toggle_button_3.clicked.connect(self.toggle_confirm_password_visibility)
        ...
        Form.setTabOrder(self.toggle_button_3, self.pushButton_2)
    ...
    def signup(self):
        name = self.lineEdit_3.text(); email = self.lineEdit_4.text().lower(); address = self.lineEdit_5.text(); password = self.lineEdit_6.text(); confirm_password = self.lineEdit_7.text()
        ...
        status = register(name, email, password, address)
        self.registration_finished.emit(status)
    ...
    def toggle_password_visibility(self):
        if self.toggle_button_2.isChecked():
            self.lineEdit_6.setEchoMode(QtWidgets.QLineEdit.Normal)                         # Display password in plaintext
            self.toggle_button_2.setIcon(QtGui.QIcon(":/resources/hide_password.png"))
        else:
            self.lineEdit_6.setEchoMode(QtWidgets.QLineEdit.Password)                       # Display password using '*'
            self.toggle_button_2.setIcon(QtGui.QIcon(":/resources/show_password.png"))

    def toggle_confirm_password_visibility(self):
        if self.toggle_button_3.isChecked():
            self.lineEdit_7.setEchoMode(QtWidgets.QLineEdit.Normal)                         # Display password in plaintext
            self.toggle_button_3.setIcon(QtGui.QIcon(":/resources/hide_password.png"))
        else:
            self.lineEdit_7.setEchoMode(QtWidgets.QLineEdit.Password)                       # Display password using '*'
            self.toggle_button_3.setIcon(QtGui.QIcon(":/resources/show_password.png"))
...
from PatientLoginController import LoginController
from UI.Login_Resources import *; from UI.Register_Resources import *
#from modules.sidebar import MySideBar          #<<<< This is Koon Teng's module for your app's logic 
#from modules.ui_doctor import Ui_MainWindow    #<<<< UI module for your main app
import sys
...
if __name__ == '__main__':
    ...
    #login_controller.show_main_app_signal.connect(lambda success : open_main_app (success, login_controller)) ## Uncomment after done merging

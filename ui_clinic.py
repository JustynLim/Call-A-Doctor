...
################################################################################
## Form generated from reading UI file 'clinicjFwMlr.ui'
##
...
"border:none;")
        ...
        if (self.schedule_table.columnCount() < 2):
        ...
        self.schedule_table.horizontalHeader().setDefaultSectionSize(279)
...
"border-radius:10px;")
        ...
        self.pushButton = QPushButton(self.addschedule_page)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(40, 30, 101, 24))
...
"border-radius:10px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"Task Name", None));
        ...
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Select Doctor", None))
    # retranslateUi